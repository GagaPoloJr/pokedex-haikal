        ...
        <BgColor key={x.type.name} color={x.type.name}>
          <div className="p-10">
            <div className="flex justify-between items-center">
              ...
              <div >
                <button onClick={capture(pokemon)}> <img className="mx-auto" src={Pokeball} alt="" />
                  <TextCatch>
                    Catch Pokemon
                  </TextCatch></button>
              </div>
            ...
            <div className="flex mt-10">
              {pokemon.types.map((type) => (
                <TypeBg key={type.type.name} colors={type.type.name}>{type.type.name}</TypeBg>
              ))}
            </div>
            <div>
            </div>
            ...
            <ImgPoke className="mx-auto" src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${pokemon.id}.png`} alt={pokemon.name} />
          ...
          <Description>
            <TabDescription pokemon={pokemon} />
          </Description>
        </BgColor>
      ))}
    </>
